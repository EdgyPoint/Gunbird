...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER][COLLIDER_GROUND_ENEMY] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_FLYING_ENEMY] = true;
	matrix[COLLIDER_PLAYER][COLLIDER_PLAYER_SHOT] = false;
	matrix[COLLIDER_PLAYER][COLLIDER_ENEMY_SHOT] = true;

	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_WALL] = true;
	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_PLAYER] = false;
	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_GROUND_ENEMY] = false;
	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_FLYING_ENEMY] = false;
	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_PLAYER_SHOT] = true;
	matrix[COLLIDER_GROUND_ENEMY][COLLIDER_ENEMY_SHOT] = false;

	matrix[COLLIDER_FLYING_ENEMY][COLLIDER_WALL] = true;
	matrix[COLLIDER_FLYING_ENEMY][COLLIDER_PLAYER] = true;
	matrix[COLLIDER_FLYING_ENEMY][COLLIDER_GROUND_ENEMY] = false;
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_GROUND_ENEMY] = true;
	...
	matrix[COLLIDER_ENEMY_SHOT][COLLIDER_GROUND_ENEMY] = false;
...
void ModuleCollision::DebugDraw()
{
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_PLAYER: // green
			...
			break;
		case COLLIDER_FLYING_ENEMY: // light red
			App->render->DrawQuad(colliders[i]->rect, 255, 128, 128, alpha);
			break;
		case COLLIDER_GROUND_ENEMY: // dark red
